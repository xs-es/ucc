...
from qiskit.transpiler.passes import ConsolidateBlocks, CollectCliffords, HighLevelSynthesis, HLSConfig
from qiskit.transpiler.passes.synthesis.unitary_synthesis import DefaultUnitarySynthesis


from ..transpiler_passes import BasisTranslator, CommutativeCancellation, Collect2qBlocks, UnitarySynthesis, Optimize1qGatesDecomposition, CXCancellation, SpectralMapping, SabreLayout
